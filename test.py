...
'''
    ...
    def test_readonly_unauthorized(self):
        ...
        self.assert_put("or/t", HTTPStatus.OK, "1", user='user1', psw='pass1')
        self.assert_put("or/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("or/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='pass2')
    ...
    def test_writeonly_unauthorized(self):
        ...
        self.assert_put("ow/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='pass1')
        self.assert_put("ow/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("ow/t", HTTPStatus.OK, "1", user='user2', psw='pass2')
        self.assert_put("ow/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='p')
        self.assert_get("ow", HTTPStatus.UNAUTHORIZED)
        self.assert_get("ow/t", HTTPStatus.UNAUTHORIZED)
        self.assert_get("ow/t", HTTPStatus.OK, "1", user='user1', psw='pass1')
        self.assert_get("ow/t", HTTPStatus.UNAUTHORIZED, user='user1', psw='p')
    ...
    def test_user_blacklist(self):
        ...
        self.assert_put("orw/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='p')
        self.assert_get("orw/t", HTTPStatus.OK, "1")
        self.assert_get("orw", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("orw/t", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("orw/t", HTTPStatus.UNAUTHORIZED, user='user1', psw='p')
        self.assert_get("orw/t", HTTPStatus.OK, "1", user='user2', psw='pass2')
    ...
    def test_readonly_user(self):
        ...
        self.assert_put("ur/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='pass1')
        self.assert_put("ur/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("ur/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='pass2')
    ...
    def test_writeonly_user(self):
        self.assert_put("uw/t", HTTPStatus.OK, "1", user='user1', psw='pass1')
        self.assert_put("uw/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("uw/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='pass2')
        self.assert_put("uw/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='p')
        self.assert_get("uw/t", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("uw/t", HTTPStatus.UNAUTHORIZED, user='user2', psw='pass2')
        self.assert_get("uw", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("uw", HTTPStatus.UNAUTHORIZED, user='user1', psw='p')
        self.assert_get("uw", HTTPStatus.UNAUTHORIZED, user='user2', psw='pass2')
    ...
    def test_readwrite_user(self):
        ...
        self.assert_put("urw/t", HTTPStatus.OK, "1", user='user1', psw='pass1')
        self.assert_put("urw/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("urw/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='pass2')
    ...
    def test_nonconfigured_path(self):
        self.assert_put("other/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='pass1')
        self.assert_put("other/t", HTTPStatus.UNAUTHORIZED, "1", user='user1', psw='p')
        self.assert_put("other/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='pass2')
        self.assert_put("other/t", HTTPStatus.UNAUTHORIZED, "1", user='user2', psw='p')
        self.assert_get("other/t", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("other/t", HTTPStatus.UNAUTHORIZED, user='user2', psw='pass2')
        self.assert_get("other", HTTPStatus.UNAUTHORIZED, user='user1', psw='pass1')
        self.assert_get("other", HTTPStatus.UNAUTHORIZED, user='user1', psw='p')
        self.assert_get("other", HTTPStatus.UNAUTHORIZED, user='user2', psw='pass2')
        self.assert_get("other", HTTPStatus.UNAUTHORIZED, user='user2', psw='p')
